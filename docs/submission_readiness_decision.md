...
Honest strongest claim: `Transfer by preserving causal mechanisms rather than matching observation statistics.` is a plausible branch-structured mechanism for sim-to-real transfer for robot manipulation, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
