...
\usepackage{url}
\usepackage{booktabs}
\title{Mechanism-Level Sim2Real Contracts: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about sim-to-real transfer for robot manipulation. The original research bet was: Transfer by preserving causal mechanisms rather than matching observation statistics. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item Robust Visual Sim-to-Real Transfer for Robotic Manipulation (2023)
\item In-Hand Manipulation of Articulated Tools with Dexterous Robot Hands with Sim-to-Real Transfer (2025)
\item Bi-Touch: Bimanual Tactile Manipulation with Sim-to-Real Deep Reinforcement Learning (2023)
\item Zero-shot sim-to-real transfer of reinforcement learning framework for robotics manipulation with demonstration and force feedback (2023)
\item SymBridge: Bilateral-Symmetry-Aware Vision-Language-Action Learning with Head-Mounted Display Teleoperation for Sim2Real Transfer in Bimanual Manipulation (n.d.)
\end{itemize}
